        ...
        if(formKey.currentState!.validate()){
          ...
          FirebaseFirestore.instance.collection("users")
              ...
              .set(model).then((value){
                Fluttertoast.showToast(msg: "Nova adresa je uspješno sačuvana.");
